                    ...
                    <table class="article-table table table-striped  ">
                        ...
                        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="article-<?php echo e($row->id); ?>">
                                ...
                                <td><?php if( $row->icon ): ?><img src="<?php echo e(url("/$row->icon")); ?>" width="100px"><?php endif; ?></td>
                                <td>
                                    <button class="edit-article btn btn-info" data-toggle="modal"
                                            ...
                                            data-video="<?php echo e($row->video); ?>">update
                                    </button>
                                </td>
                            <!--<td>
                ...
                <div class="modal-dialog modal-dialog-centered" style="max-width:800px;" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <?php echo e(Form::text('video','',['class' => 'form-control'])); ?>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(".article-table").prepend("<tr class='article-" + data.id + "'>" +
                            ...
                            "<td><button class='edit-article btn btn-info'  data-toggle='modal' data-target='#edit-modal-article' data-id='" + data.id + "' data-title='" + data.title + "' data-article='" + data.article + "' data-title-en='" + data.title_en + "' data-article-en='" + data.article_en + "'  data-video='" + data.video + "'  >update</button></td>" +
            ...
            $(document).on('click', ".delete-article", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: 'main-video-delete/' + article_id,
                            processData: false,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\far7a\resources\views/admin/pages/main-videos.blade.php ENDPATH**/ ?>