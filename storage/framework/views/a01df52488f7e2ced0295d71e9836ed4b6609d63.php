            ...
            $(document).on('click', ".delete-article", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'slider-images-delete/' + article_id,
                            processData: false,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\far7a\resources\views/admin/pages/slider-images.blade.php ENDPATH**/ ?>