                            ...
                            <tr class="article-<?php echo e($row->id); ?>">
                                ...
                                <td>
                                    <button class="edit-article btn btn-info" data-toggle="modal"
                                            ...
                                            data-title="<?php echo e($row->category_id); ?>" data-photo="<?php echo e($row->photo); ?>">update
                                    </button>
                                </td>
                                <td>
                ...
                <div class="modal-dialog modal-dialog-centered" style="max-width:800px;" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <?php echo e(Form::label('category_id', 'album')); ?>

                            <?php echo e(Form::select('category_id', $categories,null, array('class' => 'form-control','id'=>'category-id-edit'))); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', ".delete-article", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: 'photography-images/' + article_id,
                            processData: false,
            ...
            $(document).on('click', "#edit-article", function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'photography-images/' + articleId,
