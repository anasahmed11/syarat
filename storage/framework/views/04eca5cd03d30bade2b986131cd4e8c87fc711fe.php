                        ...
                        <table class="article-table table table-striped  ">
                            ...
                            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="article-<?php echo e($row->id); ?>">
                                    ...
                                    <td><button class="edit-article btn btn-info"  data-toggle="modal" data-target="#edit-modal-article" data-id="<?php echo e($row->id); ?>" data-title="<?php echo e($row->category_id); ?>"  data-photo="<?php echo e($row->photo); ?>" >update</button></td>
                    ...
                    <div class="modal-dialog modal-dialog-centered" style="max-width:800px;" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <?php echo e(Form::select('category_id', $categories,null, array('class' => 'form-control','id'=>'category-id-edit'))); ?><br>
                                <?php echo e(Form::file('photo',['class'=>'form-control-file'])); ?><br><br>
    ...
    <script>
        $( document ).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(".article-table").prepend("<tr class='article-" + data.id + "'>" +
                            ...
                            "<td><button class='edit-article btn btn-info'  data-toggle='modal' data-target='#edit-modal-article' data-id='" + data.id + "' data-title='" + data.category_id + "'  data-photo='" + data.photo + "'  >update</button></td>" +
            ...
            $(document).on('click', ".delete-article", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: 'portfolio-images/' + article_id,
                            processData: false,
            ...
            $(document).on('click', ".edit-article", function (e) {
                ...
                $("#category-id-edit").val($(this).data('title'));
            ...
            $(document).on('click', "#edit-article", function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'portfolio-images/' + articleId,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hossam-ghozal\resources\views/admin/pages/portfolio-images.blade.php ENDPATH**/ ?>