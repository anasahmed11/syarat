            ...
            <div class="col-12 h-100">
                <div class="main-menu h-100">
                    <nav class="navbar h-100 navbar-expand-lg">
                        <!-- Logo Area  -->
                        <a class="navbar-brand" href="<?php echo e(route('index')); ?>"><img src="<?php echo e(asset('public/images/logo.png')); ?>" alt="Logo" width="200px" ></a>
                        ...
                        <div class="collapse navbar-collapse" id="studioMenu">
                            ...
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('about')); ?>"><span class="custom-nav-item <?php echo e(request()->route()->getName() === 'about' ?'active' : ''); ?>">Home</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('albums')); ?>"><span class="custom-nav-item <?php echo e(request()->route()->getName() === 'albums' ?'active' : ''); ?>">Albums</span></a>
                                </li>
                                <li class="nav-item">
...
<?php /**PATH D:\xampp\htdocs\nagy\resources\views/layouts/custom-app.blade.php ENDPATH**/ ?>