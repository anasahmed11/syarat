            ...
            <form>
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-danger "><a href="<?php echo e(route('articles')); ?>" style="color: white"><i
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(".article-table").prepend("<tr class='article-" + data.id + "'>" +
                            ...
                            "<td><button class='edit-article btn btn-info'  data-toggle='modal' data-target='#edit-modal-article' data-id='" + data.id + "' data-title='" + data.title + "' data-article='" + data.article + "' data-title-en='" + data.title_en + "' data-article-en='" + data.article_en + "' data-category='" + data.category_id + "' data-photo='" + data.photo + "'  >update</button></td>" +
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\far7a\resources\views/admin/pages/articles.blade.php ENDPATH**/ ?>