...
<li class="nav-item dropdown user-menu">
    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        ...
        <?php endif; ?>
        <span style="color: white !important;" <?php if(config('adminlte.usermenu_image')): ?> class="d-none d-md-inline" <?php endif; ?>>
            ...
            <li class="user-header <?php echo e(config('adminlte.usermenu_header_class', 'bg-primary')); ?>
                ...
                <?php if(config('adminlte.usermenu_image')): ?>
                    <img src="<?php echo e(Auth::user()->adminlte_image()); ?>"
                         ...
                         alt="<?php echo e(Auth::user()->first_name); ?>">
                <?php endif; ?>
                <p style="color: white !important;" class="<?php if(!config('adminlte.usermenu_image')): ?> mt-0 <?php endif; ?>">
                    <?php echo e(Auth::user()->first_name); ?>
...
<?php /**PATH C:\xampp\htdocs\syarat\resources\views/vendor/adminlte/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>