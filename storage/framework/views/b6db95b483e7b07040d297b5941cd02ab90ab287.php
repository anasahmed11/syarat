                            ...
                            <tr class="article-<?php echo e($row->id); ?>">
                                ...
                                <td>
                                    <button class="edit-article btn btn-info" data-toggle="modal"
                                            data-target="#edit-modal-article" data-id="<?php echo e($row->id); ?>">update
                                    </button>
                                </td>
                                <td>
            ...
            $(document).on('click', ".delete-article", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'estate-image-delete/' + article_id,
                            processData: false,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\far7a\resources\views/admin/pages/estate-images.blade.php ENDPATH**/ ?>